...
# Purpose:
# This scrip will initiate a playbook that will set passwordless priviledges for the secondary namenode
...
# eg.  run-hadoop-1-set-2nn-ssh-playbook.yml --extra-vars "hadoop_version=1.2.1"
